...
BASE_PERMISSIONS = [
    ...
    ("user.unlock", "Reset a user's failed-login lockout"),
    ...
    ("deployment_ingress.manage", "Create, edit, and delete Kubernetes Ingresses"),
    ("deployment_network_policy.manage", "Create, edit, and delete Kubernetes Network Policies"),
